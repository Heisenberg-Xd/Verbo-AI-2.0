...
// Fix: Use Next.js dynamic import with SSR disabled instead of React.lazy
// React.lazy causes infinite hydration mismatch loops / re-renders in Next.js App Router for canvas/WebGL comps
const Dithering = dynamic(
  () => import("@paper-design/shaders-react").then((mod) => mod.Dithering),
  { ssr: false, loading: () => <div className="absolute inset-0 bg-muted/20" /> }
)
